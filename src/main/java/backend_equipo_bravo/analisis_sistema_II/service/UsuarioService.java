...
public class UsuarioService {
    ...
    public Usuario actualizarUsuario(String idUsuarioActualizar, UsuarioUpdateRequest request) {
        ...
        boolean intentaCambiarSensibles =
                request.getIdRole() != null ||
        ...
        Usuario usuarioDestino =
                usuarioRepository.findByIdUsuario(idUsuarioActualizar)
                        .orElseThrow(() ->
        ...
        if (request.getFechaNacimiento() != null) {
            usuarioDestino.setFechaNacimiento(request.getFechaNacimiento());
        }

        if (request.getCorreoElectronico() != null) {
            usuarioDestino.setCorreoElectronico(
                    request.getCorreoElectronico()
            );
        }

        if (request.getTelefonoMovil() != null) {
            usuarioDestino.setTelefonoMovil(request.getTelefonoMovil());
        }

        if (request.getIdSucursal() != null) {
            usuarioDestino.setIdSucursal(request.getIdSucursal());
        }

        if (request.getIdRole() != null) {
            usuarioDestino.setIdRole(request.getIdRole());
        }

        if (request.getIdStatusUsuario() != null) {
            usuarioDestino.setIdStatusUsuario(
                    request.getIdStatusUsuario()
            );
        }

        if (request.getIntentosDeAcceso() != null) {
            usuarioDestino.setIntentosDeAcceso(
                    request.getIntentosDeAcceso()
            );
        }
    ...
    public Usuario actualizarPrimerIngreso(String password) {
        ...
        Usuario usuario =
                usuarioRepository.findByIdUsuario(idUsuarioLog)
                        .orElseThrow(() ->
                                new BusinessException(
                                        UsuarioError.AUTH_USER_NOT_FOUND
                                ));
        ...
        if (passwordEncoder.matches(
            ...
            throw new BusinessException(
                    UsuarioError.AUTH_PASSWORD_EQUALS
            );
        }
    ...
    public int getChangePassword() {
        ...
        if (
                usuario.getUltimaFechaCambioPassword() == null ||
                usuario.getRequiereCambiarPassword() == null ||
                usuario.getRequiereCambiarPassword() == 1 ||
                isReno
        ) {
        ...
        return usuario.getRequiereCambiarPassword() != null
                ? usuario.getRequiereCambiarPassword()
                : 1;
    }
    ...
    private boolean validarRenovacionPassword(Usuario usuario) {
        ...
        Empresa empresa =
                politicasService.obtenerEmpresaPorSucursal(
                        usuario.getIdSucursal()
                );

        Integer diasCaducidad =
    ...
    public UsuarioPerfilResponse getDataPerfil() {
        ...
        Sucursal sucursal =
                sucursalRepository.findById(usuario.getIdSucursal())
                        .orElseThrow(() ->
                                new BusinessException(
        ...
        Empresa empresa =
                empresaRepository.findById(sucursal.getIdEmpresa())
                        .orElseThrow(() ->
                                new BusinessException(
        ...
        response.setUltimaFechaIngreso(
                FechaUtil.formatear(
                        usuario.getUltimaFechaIngreso(),
                        FormatoFecha.YYYY_MM_DD_HH_MM_SS
                )
        );
    ...
    public Usuario actualizarPerfil(
        ...
        Usuario usuario =
                usuarioRepository.findByIdUsuario(idUsuarioEjecutor)
                        .orElseThrow(() ->
                                new BusinessException(
                                        UsuarioError.AUTH_USER_NOT_FOUND
                                ));
        ...
        if (usuario == null) {
            throw new BusinessException(
                    UsuarioError.AUTH_UNAUTHORIZED
            );
        }
    ...
    public Usuario cambioPassword(
        ...
        if (!passwordEncoder.matches(
            ...
            int intentosActuales =
                    usuario.getIntentosDeAcceso() != null
            ...
            int intentosPermitidos =
                    politicasService.obtenerIntentosPermitidosPorSucursal(
                            usuario.getIdSucursal()
                    );
            ...
            if (intentosActuales >= intentosPermitidos) {
                ...
                auditoriaService.registrarIntento(
                        idUsuarioLog,
                        3,
                        ip,
                        userAgent,
                ...
                throw new BusinessException(
                        UsuarioError.AUTH_USER_BLOCKED_ATTEMPTS
                );
                ...
                throw new BusinessException(
                        UsuarioError.AUTH_INVALID_CREDENTIALS_ATTEMPTS,
                        intentosActuales,
                        intentosPermitidos
                );
            }
        ...
        usuario.setPassword(
                passwordEncoder.encode(passwordNew)
        );
